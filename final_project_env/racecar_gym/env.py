...
def with_random_mode_reset(method):
    """
    Decorator to modify the reset method of RaceEnv to ensure
    scenario reset uses a random mode if specified in kwargs.
    """

    def wrapper(self, *args, **kwargs):
        # Inject a random reset mode if not specified
